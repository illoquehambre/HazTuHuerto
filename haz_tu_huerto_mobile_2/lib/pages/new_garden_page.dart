...
class NewGardenPage extends StatefulWidget {
  const NewGardenPage({super.key});

  @override
  State<NewGardenPage> createState() => _NewGardenPageState();
}

class _NewGardenPageState extends State<NewGardenPage> {
  @override
...
class NewGardenPageSF extends StatefulWidget {
  final NewGardenFormBloc formBloc;
  const NewGardenPageSF({super.key, required this.formBloc});

  @override
  State<NewGardenPageSF> createState() => _NewGardenPageSFState();
}

class _NewGardenPageSFState extends State<NewGardenPageSF> {
