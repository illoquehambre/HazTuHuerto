    ...
    return BlocProvider(
      ...
      child: Builder(
        builder: (context) {
          ...
          return FormBlocListener<NewQuestFormBloc, String, String>(
            ...
            child: NewQuestPageSF(formBloc: formBloc),
          );
        },
      ),
    );
...
class NewQuestPageSF extends StatefulWidget {
  final NewQuestFormBloc formBloc;
  const NewQuestPageSF({super.key, required this.formBloc});

  @override
  State<NewQuestPageSF> createState() => _NewQuestPageSFState();
}

class _NewQuestPageSFState extends State<NewQuestPageSF> {
