...
import 'package:haz_tu_huerto_mobile_2/blocs/garden/update_garden_form/update_garden_form_bloc.dart';
...
class UpdateGardenPage extends StatefulWidget {
  final String id;
  const UpdateGardenPage({super.key, required this.id});

  @override
  State<UpdateGardenPage> createState() => _UpdateGardenPageState();
}
...
class _UpdateGardenPageState extends State<UpdateGardenPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => UpdateGardenFormBloc(_gardenService, widget.id),
      child: Builder(
        builder: (context) {
          final formBloc = context.read<UpdateGardenFormBloc>();
          return FormBlocListener<UpdateGardenFormBloc, String, String>(
            ...
            child: UpdateGardenPageSF(formBloc: formBloc),
          );
        },
      ),
    );
...
class UpdateGardenPageSF extends StatefulWidget {
  final UpdateGardenFormBloc formBloc;
  const UpdateGardenPageSF({super.key, required this.formBloc});

  @override
  State<UpdateGardenPageSF> createState() => _UpdateGardenPageSFState();
}

class _UpdateGardenPageSFState extends State<UpdateGardenPageSF> {
